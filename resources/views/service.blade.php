...
<html lang="en">
  ...
  <body>
    <div class="test-block">
        <h2 class="test-title">服務條款</h2>
        <!-- -- -->
        <ul class="test-list inside">
            <p>一、會員服務條款</p>
            <li>
        ...
        <ul class="test-list inside">
            ...
            <li>
                未經會員本人同意，本公司原則上不會將涉及個人隱私之資料開示給第三者，唯資料共用原則...等不在此限(請參閱本站「隱私權政策」相關規定)。
            </li>
            <li>
        ...
        <ul class="test-list inside">
            ...
            <li>
                ...
                <ul class="test-list-details">
                    <li>對本服務相關軟硬體設備進行更換、升級、保養或施工時。</li>
                    <li>發生突發性之電子通信設備故障時。</li>
                    <li>天災或其他不可抗力之因素致使本網站無法提供服務時。</li>
                </ul>
            </li>
            <li>
