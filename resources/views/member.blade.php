        ...
        <div class="gold-flow col">
            ...
            <div class="member-block">
                <div class="member-title">
                    <h2>預付金儲值紀錄</h2>
                    @if(Auth::user()->role == 99)
                    <button class="btn member-infro gold-add vendor-btn" onclick="create_modalFirst()">新增</button>
                    @endif
                </div>
                <!-- table stored -->
            ...
            <form action="" method="POST">
                ...
                <div class="modal-body edit-body">
                    <span class="edit-data gold-data">
                        <p>儲值日期</p><input type="date" value="{{ $deposit->c_date }}">
                    </span>
                    <span class="edit-data">
                        <p>儲值金額 <br> (台幣)</p><input type="number" value="{{ $deposit->amount }}">
                    </span>
                    <span class="edit-data gold-data">
                        <p>使用匯率</p><input type="number" value="{{ $deposit->rate }}">
                    </span>
                    <span class="edit-data gold-data">
                        <p>日幣金額</p><input type="number" value="{{ $deposit->note }}">
                    </span>
                    <span class="edit-data gold-data">
                        <p>備註</p><input type="text" value="">
                    </span>
                </div>
                <!-- gold edit submit -->
                <div class="modal-footer edit-footer">
    ...
    <div class="modal-dialog edit-dialog " role="document">
        <div class="modal-content edit-content">
            ...
            <form action="" method="POST">
                ...
                <div class="modal-body edit-body">
                    <span class="edit-data gold-data">
                        <p>入倉日期</p><input type="date" value="{{ $store->c_date }}">
                    </span>
                    <span class="edit-data">
                        <p>國內運輸公司/取貨地點 <br> (台幣)</p><input type="number" value="{{ $store->location }}">
                    </span>
                    <span class="edit-data gold-data">
                        <p>日本國內運輸公司追蹤單號</p><input type="number" value="{{ $store->store_no }}">
                    </span>
                </div>
                <!-- gold edit submit -->
                <div class="modal-footer edit-footer">
